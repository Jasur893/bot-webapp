    ...
    if($text == "/start"){
        ...
        bot('sendmessage', [
            ...
            'reply_markup' => json_encode([
                'inline_keyboard' => [
                    [
                        [ 'text' => "Eco mahsulotlar", 'web_app' => ['url' => '  https://d95a-94-232-25-6.ngrok-free.app/bot_green_market/store/']]
                    ]
                ]
            ])
        ]);
    ...
    if($text == "/start"){
        ...
        bot('sendmessage', [
            ...
            'reply_markup' => json_encode([
                'inline_keyboard' => [
                    [
                        [ 'text' => "Bot CMS dasturi", 'web_app' => ['url' => 'https://d95a-94-232-25-6.ngrok-free.app/bot_green_market/']]
                    ],
                    [
                        [ 'text' => "Bizning dukon", 'web_app' => ['url' => 'https://d95a-94-232-25-6.ngrok-free.app/bot_green_market/store/']]
                    ],
                ]
            ])
        ]);
    ...
    if (order(['succ_order' => $message])) {
        ...
        bot('sendmessage', [
            ...
            'reply_markup' => json_encode([
                'inline_keyboard' => [
                    [
                        [ 'text' => "Bonusingizni olish", 'web_app' => ['url' => ' https://d95a-94-232-25-6.ngrok-free.app/bot_green_market/store/']]
                    ],
                ]
            ])
        ]);
